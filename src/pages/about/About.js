    ...
    return (
      <PageLayout title="About">
        <div className="about-content">
          ...
          <Paragraph className="math-block">
          ...
          <Paragraph>
            ...
            The best result is the minimum result across all <Latex>$M$</Latex> competitors as follows
          </Paragraph>
          <Paragraph className="math-block">
          ...
          <ul>
            <li>
              <Paragraph>
                ...
                of <Latex>{"$x_{c,i}$"}</Latex> for all competitors, and the second using the mean result
                for <Latex>{"$x_{c,i}$"}</Latex>. The highest of the two candidate values for <Latex>{"$K_{c,i}$"}</Latex> is used.
                This is applied separately for each competitor, so one competitor's score may be calculated using best single results,
            ...
            <li>
              ...
              <Paragraph>
                ...
                the number of cubes successfully solved minus the number of cubes that were not
          ...
          <Paragraph>
            It also means that a competitor can receive 0 points for an event that they compete in (for example,
